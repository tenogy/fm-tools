...
using Tenogy.Tools.FluentMigrator.UpdateDatabase.Console;
...
}).ConfigureServices(services =>
{
	...
	// Tool
	services.AddSingleton<IFluentMigratorRunnerService, FluentMigratorRunnerService>();
	services.AddSingleton<IVersionTableFinderService, VersionTableFinderService>();
	services.AddSingleton<IUpdateDatabaseTool, UpdateDatabaseTool>();
